-file("/Users/thiago/projects/erl23.3.1/lib/parsetools-2.2/include/leexinc.hrl", 0).
...
norm_str(C, Len, L) ->
    ...
    {token, {'str', Cs1, L}}.
-file("/Users/thiago/projects/erl23.3.1/lib/parsetools-2.2/include/leexinc.hrl", 14).
...
-file("src/fml_lexer.xrl", 6).
yyaction_0(TokenChars, TokenLine) ->
     name_alphan (TokenChars, TokenLine) .

-compile({inline,yyaction_1/1}).
-file("src/fml_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/fml_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/fml_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/fml_lexer.xrl", 10).
yyaction_4(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/fml_lexer.xrl", 11).
yyaction_5(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/fml_lexer.xrl", 12).
yyaction_6(TokenLine) ->
     { token, { '>', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/fml_lexer.xrl", 13).
yyaction_7(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/fml_lexer.xrl", 14).
yyaction_8(TokenLine) ->
     { token, { '{', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/fml_lexer.xrl", 15).
yyaction_9(TokenLine) ->
     { token, { '}', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/fml_lexer.xrl", 16).
yyaction_10(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("src/fml_lexer.xrl", 17).
yyaction_11(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_12/0}).
-file("src/fml_lexer.xrl", 18).
yyaction_12() ->
     skip_token .

-compile({inline,yyaction_13/3}).
-file("src/fml_lexer.xrl", 20).
yyaction_13(TokenChars, TokenLen, TokenLine) ->
     norm_str (TokenChars, TokenLen, TokenLine) .

-compile({inline,yyaction_14/3}).
-file("src/fml_lexer.xrl", 21).
yyaction_14(TokenChars, TokenLen, TokenLine) ->
     norm_str (TokenChars, TokenLen, TokenLine) .

-file("/Users/thiago/projects/erl23.3.1/lib/parsetools-2.2/include/leexinc.hrl", 313).
